...
#-----------------------------------------------------------------------------#
path_to_models = '/import/gijs-shared/gijs/sentence_encoders/SkipThought/models/'
path_to_tables = '/import/gijs-shared/gijs/sentence_encoders/SkipThought/models/'
#-----------------------------------------------------------------------------#
